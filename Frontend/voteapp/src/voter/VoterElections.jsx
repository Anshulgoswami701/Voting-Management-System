...
import { CalendarDays, CheckCircle2, Filter, Loader2, Search, Vote } from "lucide-react";
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <button
              ...
              className="mb-4 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-600 hover:bg-slate-50"
            >
              ← Back
            </button>
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-3 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
              />
            </div>
            ...
            <div className="relative min-w[180px]">
              ...
              <select
                ...
                className="w-full appearance-none rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-3 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
              >
        ...
        {filteredElections.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-10 text-center">
            <Vote className="mx-auto text-slate-400" size={36} />
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {filteredElections.map((election) => (
              <div key={election._id} className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div className="border-b border-slate-100 bg-slate-50 p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <p className="text-xs font-medium uppercase tracking-[0.12em] text-slate-400">Election</p>
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 space-y-3 rounded-xl bg-slate-50 p-3 text-sm text-slate-600">
